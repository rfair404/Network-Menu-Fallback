...
function rlfs_network_menu($args){
...
add_filter('wp_nav_menu_args', 'rlfs_network_menu_args' );
function rlfs_network_menu_args($args){
    $args['fallback_cb']  = 'rlfs_network_menu';
}
